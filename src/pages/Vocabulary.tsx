    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-gray-600">
          Master 3,000-5,000 most common English words with flashcards, quizzes, and interactive exercises
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="relative p-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Word List</h2>
            <p className="text-gray-600 mb-6">
              Browse and study thousands of English words with definitions, examples, and pronunciation
            </p>
        ...
        >
          ...
          <div className="relative p-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Vocabulary Quiz</h2>
            <p className="text-gray-600 mb-6">
              Test your knowledge with multiple choice questions, definition matching, and word selection exercises
            </p>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="text-gray-600">Common Words</div>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md">
          <div className="text-3xl font-bold text-primary-600 mb-2">5,000+</div>
          <div className="text-gray-600">Advanced Words</div>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md">

    ...
    <div className="space-y-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-16">
        ...
        >
          ...
          <div className="relative p-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Grammar</h2>
      ...
      <div className="mt-20 grid md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <p className="text-gray-600">Test your knowledge after each lesson with comprehensive quizzes</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <p className="text-gray-600">Monitor your learning progress and see your improvement over time</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <p className="text-gray-600">Access thousands of words and grammar rules in one place</p>
        </div>
      </div>
    </div>
  )
